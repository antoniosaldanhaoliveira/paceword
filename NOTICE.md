...
This repository is an **independent audit**. It is not affiliated with, endorsed by,
or produced in collaboration with the author of CTHmodules.

- **CTHmodules** (the audited software) is by Alejo Malia, licensed CC BY-NC-SA 4.0.
  It is not vendored here; `README.md` documents how to clone it.
